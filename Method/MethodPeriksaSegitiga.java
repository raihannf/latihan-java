/*
Buatlah method fungsi atau prosedur dalam bahasa Java yang membaca panjang (integer) tiga buah sisi
...
public class MethodPeriksaSegitiga {
    static void periksaSegitiga(int a, int b, int c){
        if (c > (a + b)) {
